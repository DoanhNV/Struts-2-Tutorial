...
<body>
	<s:form action="/admin2/register2" method="POST">
		<s:textfield name="userName" label="UserName: " />
		<s:password name="password" label="Password: "/>
		<s:checkboxlist name="favorites"  list="listFavor" label="Favorites: "/>
		<%-- Default Value: value="'Cook'"  --%>
		<s:radio name="gender" list="genders" listValueKey="displayText" listValue="displayValue"/>
